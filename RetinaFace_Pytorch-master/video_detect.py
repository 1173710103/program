...
def get_args():
    ...
    parser.add_argument('--video_path', type=str, default='20200320_183950.mp4', help='Path for image to detect')
...
def main():
    ...
    pre_state_dict = torch.load(args.model_path,map_location='cpu')
